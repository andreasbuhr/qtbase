...
struct MoveOnlySequenceItem
{
    ...
    MoveOnlySequenceItem(MoveOnlySequenceItem &&) = default;
    MoveOnlySequenceItem &operator=(const MoveOnlySequenceItem &) = delete;
    MoveOnlySequenceItem &operator=(MoveOnlySequenceItem &&) = default;
...
struct MoveOnlyNoConstructSequenceItem
{
    ...
    MoveOnlyNoConstructSequenceItem(MoveOnlyNoConstructSequenceItem &&) = default;
    MoveOnlyNoConstructSequenceItem &operator=(const MoveOnlyNoConstructSequenceItem &) = delete;
    MoveOnlyNoConstructSequenceItem &operator=(MoveOnlyNoConstructSequenceItem &&) = default;
...
public:
    ...
    MyMoveOnlyFilter(MyMoveOnlyFilter<T> &&) = default;
    MyMoveOnlyFilter &operator=(MyMoveOnlyFilter<T> &&) = default;
...
public:
    ...
    MyMoveOnlyMap(MyMoveOnlyMap<From, To> &&) = default;
    MyMoveOnlyMap &operator=(MyMoveOnlyMap<From, To> &&) = default;
...
public:
    ...
    MyMoveOnlyInplaceMap(MyMoveOnlyInplaceMap<T> &&) = default;
    MyMoveOnlyInplaceMap &operator=(MyMoveOnlyInplaceMap<T> &&) = default;
...
public:
    ...
    MyMoveOnlyReduce(MyMoveOnlyReduce<From, To> &&) = default;
    MyMoveOnlyReduce &operator=(MyMoveOnlyReduce<From, To> &&) = default;
